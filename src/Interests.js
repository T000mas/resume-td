...
export default function Interests() {
  return (
    <div className="container interests">
      ...
      <p>
        My hobbies are <strong>windsurfing</strong> and
      ...
      <p>
        ...
        brother. My beloved games are "Divinity: Orginal Sin 2", "The Witcher 3:
        Wild Hunt" and "Halo 3". When new big game is released I almost always
        play through it.
      </p>
    </div>
  );
